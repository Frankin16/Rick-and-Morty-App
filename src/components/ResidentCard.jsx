            ...
            <section className="resident__body">
                ...
                <ul className="resident__list ">
                    <li className="resident__item">
                        ...
                        <span className="resident__item-value">{character?.species}</span></li>
                    <li className="resident_item">
                        <span className="resident__label">Origin</span>
                        <span className="resident__item-value">{character?.origin.name}</span></li>
                    <li className="resident_item">
                        <span className="resident__label">Eppisodes where appeare</span>
                        <span className="resident__item-value">{character?.episode.length}</span></li>
